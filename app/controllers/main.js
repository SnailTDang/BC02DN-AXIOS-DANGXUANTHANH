        ...
        return `
            <tr>
                ...
                <td>
                    <img src="${
                        e.hinhAnh
                    }" alt="" style="width:50px; height: 50px; border-radius: 50%; margin-right: 8px; object-fit: cover;">
                ...
                <td>
                    <button class="btn btn-success" data-toggle="modal"  data-target="#myModal" onclick="showDetails(${
                        e.id
                    })">Xem</button>
...
let addBtn = () => {
    ...
    ).innerHTML = `<button class="btn btn-success" onclick="addNewMember()">Thêm người dùng</button>`;
...
let showDetails = (id) => {
    ...
    document.querySelector(
        "#myModal .modal-footer"
    ).innerHTML = `<button class="btn btn-success" onclick="updateMember(${id})">Cập nhật</button>`;
    memberServ
        .getMember(id)
        .then((result) => {
            let {
...
let updateMember = (id) => {
    ...
    isValid &=
        ...
        validation.checkLong(MoTa, "tbMoTa", "Mô tả không được quá 60 ký tự");
